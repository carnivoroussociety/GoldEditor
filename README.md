...
| Version | URL |
| ----------------------- | ----------- |
| Latest exe (recommended) | [gesetupeditorinstaller.exe](https://github.com/carnivoroussociety/GoldEditor/releases/download/3.0/gesetupeditorinstaller.exe) |
| Latest zip (no installer) | [gesetupeditor.7z](https://github.com/carnivoroussociety/GoldEditor/releases/download/3.0/gesetupeditor.7z) |
| Legacy 3.0 (XP and lower) | [geeditsetupeditorinstaller3.exe](https://github.com/carnivoroussociety/GoldEditor/releases/download/Legacy/geeditsetupeditorinstaller3.exe) |
